...
fn injectSetupHelpers(lua: *Lua) void {
    const code =
        ...
        "hexe.action.speech=hexe.action.speech or {}; hexe.action.speech.start=hexe.action.speech.start or function(o) return action('speech.start',o) end; hexe.action.speech.stop=hexe.action.speech.stop or function(o) return action('speech.stop',o) end; " ++
