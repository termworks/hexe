...
pub fn finishCreatePane(self: anytype, flight: *pane_creation.InFlightPane, child_pid: std.posix.pid_t) !*store_mod.Pane {
    return pane_creation.finishCreatePane(self, flight, child_pid);
}

pub fn abortCreatePane(self: anytype, flight: *pane_creation.InFlightPane) void {
    pane_creation.abortCreatePane(self, flight);
}
