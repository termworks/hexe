...
<!-- demo:begin -->
[![floats demo](https://asciinema.org/a/1262980.svg)](https://asciinema.org/a/1262980)
<!-- demo:end -->
...
- **A float whose command exits closes.** `git log` flashes and is gone unless the command keeps a
  process alive — `…; exec bash` is the usual fix.
...
| `docs/floats.md`, `docs/float_attributes.md` | the reference pages |
