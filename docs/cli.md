...
- **`hexe com` does not exist** in this build, and neither do `hexe ses open` or
  `hexe ses freeze` — they are `hexe layout open` and `hexe layout save`. Older documentation and
  older muscle memory both say otherwise.
