...
local SMOKES = {
  ...
  "smoke_inherit_env.py", "smoke_access.py", "smoke_capture.py", "smoke_plugin_pkg.py", "smoke_popup.py", "smoke_plugin_stream.py", "smoke_share_indicator.py", "smoke_stream_attach.py", "smoke_status_zones.py",
}
